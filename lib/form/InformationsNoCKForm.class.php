 ...
 */
class InformationsNoCKForm extends BaseInformationsForm
{
  public function configure()
  {
    ...
    foreach ($langues as $langue) {
      ...
      $this->widgetSchema[$langue->getIso()]['value'] = new sfWidgetFormInputText();
    }
  }
  
  public function setWidgetNameFormat($name)
  {
