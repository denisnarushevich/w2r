      ...
      <li <?php echo $item['in_menu']? 'class="item"':'class="item-menu"'; ?>>
        <a href="<?php echo url_for($item['url']) ?>" title="<?php echo __($item['name'], null, 'admin') ?>">
          <?php if (sfAdminDash::getProperty('resize_mode') == 'thumbnail'): ?>
            <?php echo image_tag(substr($item['image'], 0, strrpos($item['image'], '/')).'/small/'.substr($item['image'], strrpos($item['image'], '/') + 1), array('alt' => __($item['name'], null, 'admin'), 'width' => '16', 'height' => '16')); ?>
          <?php else: ?>
            <?php echo image_tag($item['image'], array('alt' => __($item['name'], null, 'admin'), 'width' => '16', 'height' => '16')); ?>
          <?php endif; ?>
