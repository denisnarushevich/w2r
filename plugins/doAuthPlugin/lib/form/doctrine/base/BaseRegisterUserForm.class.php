...
class BaseRegisterUserForm extends PluginUserForm {
  ...
  public function configure()
  {
    ...
    $this->setValidators(array(
      ...
      'phone'          => new sfValidatorString(array('max_length' => 14)),
      'email' => new sfValidatorEmail(array('required'=> true)),
      'password' => new sfValidatorString(array('required'=> true)),
      'repeat_password' => new sfValidatorString(array('required'=> true)),
    ));

    unset($this['id'],$this['is_active'],$this['is_super_admin'],$this['last_login'],$this['created_at'],$this['updated_at'], $this['salt']);
